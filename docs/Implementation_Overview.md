...
**Student:** עפרי חמו — 211906813 · **Engine:** Unity 6000.4.8f1, URP · **Full detail:** `docs/Implementation_Plan.md` · **Click-by-click:** `docs/Phase1_Unity_Walkthrough.md`, `docs/Phase2_Unity_Walkthrough.md`, `docs/Phase3_Unity_Walkthrough.md`
